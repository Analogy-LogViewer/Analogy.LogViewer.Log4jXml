...
namespace Analogy.LogViewer.Log4jXml.IAnalogy
{
    ...
    {
        protected override string RepositoryURL { get; set; } = "https://api.github.com/repos/Analogy-LogViewer/Analogy.LogViewer.Log4jXml";
        ...
        public override string Name { get; set; } = "Log4jXml Data Provider";
